...
(:domain batter-trader)
	...
	(:init
		...
		(=(sell-price goods2 market3)3)	(=(on-sale goods2 market3)5)
		(=(sell-price goods1 market3)2) (=(on-sale goods1 market3)2)
	...
	(:goal (and
		...
		(>=(available  goods2 village0)4)
	
		
		)
	)

;;(:metric minimize (+(*2(liquidity)) (+ (*5(expenditure)) (*4(labour)))))
