...
(:domain batter-trader)
	...
	(:init
		...
		(=(sell-price goods2 market0)1) (=(on-sale goods2 market0)0) 
		...
		(=(sell-price goods1 market1)1) (=(on-sale goods1 market1)4)
		...
		(=(sell-price goods2 market2)1)	(=(on-sale goods2 market2)5)
...
;;(:metric minimize (+ (*2 (liquidity)) (+( *2(resource))(*5(expenditure)))))
