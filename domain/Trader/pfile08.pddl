...
(:domain batter-trader)
	...
	(:init
		...
		(=(sell-price goods1 market2)3) (=(on-sale goods1 market2)4)
...
;;(:metric minimize (+ (*10(liquidity)) (+( *2(resource))(expenditure))))
