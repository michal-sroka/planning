...
(:domain batter-trader)
	...
	(:init
		...
		(=(available goods6 village0)0)

		(=(cash)100) (=(expenditure)0) (=(labour)0) (=(resource)0) (=(liquidity)0)
		...
		(=(sell-price goods1 market0)1) (=(on-sale goods1 market0)6)
		...
		(buy goods6 market0) (=(buy-price goods6 market0)4)
		(buy goods0 market0) (=(buy-price goods0 market0)2)
		...
		(=(sell-price goods3 market2)1) (=(on-sale goods3 market2)2)
		...
		(=(sell-price goods5 market3)1) (=(on-sale goods5 market3)4)
		(buy goods0 market3) (=(buy-price goods0 market3)3)
		...
		(=(sell-price goods6 market4)2) (=(on-sale goods6 market4)5)
		(buy goods0 market4) (=(buy-price goods0 market4)3)
		(trading goods0 goods3 market4)
		(trading goods0 goods4 market4)
		(trading goods0 goods6 market4)
		(trading goods1 goods3 market4)
		
)
	(:goal (and
		(>=(available goods1 village0)2) 
		(>=(available goods2 village0)2)
		(>=(available goods3 village0)2)
		(>=(available goods4 village0)3)
		(>=(available goods5 village0)2)
		(>=(available goods6 village0)2)
		(is-at person0 village0)
		
		)
	)

;;(:metric minimize (+ (expenditure) (*5(liquidity))))
