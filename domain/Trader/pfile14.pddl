...
(:domain batter-trader)
	...
	(:init
		...
		(=(cash)70) (=(expenditure)0) (=(labour)0) (=(resource)0) (=(liquidity)0)
		...
		(=(sell-price goods0 market0)2) (=(on-sale goods0 market0)4) 
...
;;(:metric minimize (+ (*5 (expenditure)) (+( *4(resource))(*2(labour)))))
