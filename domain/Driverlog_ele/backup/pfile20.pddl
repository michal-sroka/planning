(define (problem DLOG-8-6-25)
 ...
 truck_e_3 - electrictruck
	truck_p_4 - petroltruck 
 truck_e_4 - electrictruck
	truck_p_5 - petroltruck 
 truck_e_5 - electrictruck
	truck_p_6 - petroltruck 
 truck_e_6 - electrictruck
	package1 - obj
	package2 - obj
	package3 - obj
	package4 - obj
...
(at truck_e_4 s17)
	(empty truck_p_4)
(= (load truck_p_4) 0)
(= (fuel-per-minute truck_p_4) 10)
(empty truck_e_4)
(= (load truck_e_4) 0)
(= (electricity-per-minute truck_e_4) 10)
	(at truck_p_5 s16)
(at truck_e_5 s16)
	(empty truck_p_5)
(= (load truck_p_5) 0)
(= (fuel-per-minute truck_p_5) 10)
(empty truck_e_5)
(= (load truck_e_5) 0)
(= (electricity-per-minute truck_e_5) 10)
	(at truck_p_6 s16)
(at truck_e_6 s16)
	(empty truck_p_6)
(= (load truck_p_6) 0)
(= (fuel-per-minute truck_p_6) 10)
(empty truck_e_6)
(= (load truck_e_6) 0)
(= (electricity-per-minute truck_e_6) 10)
	(at package1 s18)
	(at package2 s15)
	(at package3 s8)
	(at package4 s2)
