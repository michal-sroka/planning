(define (problem prob1)
	...
	(:requirements :typing :fluents :equality :adl)
  	(:objects chemical iron - raw-material
...
;		product1 product2 uncoated-product2    - product 
...
;		clean-metal clean-plastic	  - clean-material 
	...
	(:init 	(= (labour) 0) 
		(= (machine-cost)0) 
		(available coater0) (warm oven0) (=(hazard)0)
...
(:metric minimize (+ (* (hazard) 10) (+ (* (labour) 4) (* (machine-cost) 9) )) )
